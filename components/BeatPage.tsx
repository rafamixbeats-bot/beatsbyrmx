        ...
        <div className="max-w-2xl mx-auto space-y-8">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-[10px] font-mono tracking-widest uppercase">
              <span className="bg-black px-3 py-1.5 rounded-sm border border-green-900/50 text-green-700 uppercase">{beat.bpm} BPM</span>
              <span className="bg-black px-3 py-1.5 rounded-sm border border-green-900/50 text-green-700">{beat.key}</span>
              <span className="bg-[#1e0538] text-purple-300 px-3 py-1.5 rounded-sm border border-purple-900/50 uppercase">{beat.duration}</span>
            </div>
          </div>
