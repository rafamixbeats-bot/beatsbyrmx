...
const WaveformBg: React.FC = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
    ...
    `}</style>
    <div className="absolute inset-0 flex items-center" style={{ animation: 'wavePulse 4s ease-in-out infinite' }}>
      <svg viewBox="0 0 2400 200" className="w-[200%] h-48 opacity-[0.08]" style={{ animation: 'waveMove1 8s linear infinite' }} preserveAspectRatio="none">
        <polyline
          fill="none"
          stroke="#4ade80"
          strokeWidth="2"
          points="0,100 15,100 25,80 35,100 45,100 55,50 65,100 75,100 85,115 95,100 105,100 115,35 125,100 135,100 145,125 155,100 165,100 175,90 185,100 195,100 205,45 215,100 225,100 235,130 245,100 255,100 265,65 275,100 285,100 295,100 305,85 315,100 325,100 335,50 345,100 355,100 365,120 375,100 385,100 395,75 405,100 415,100 425,30 435,100 445,100 455,125 465,100 475,100 485,60 495,100 505,100 515,100 525,90 535,100 545,100 555,40 565,100 575,100 585,115 595,100 605,100 615,70 625,100 635,100 645,25 655,100 665,100 675,120 685,100 695,100 705,55 715,100 725,100 735,100 745,80 755,100 765,100 775,35 785,100 795,100 805,115 815,100 825,100 835,65 845,100 855,100 865,45 875,100 885,100 895,130 905,100 915,100 925,75 935,100 945,100 955,100 965,55 975,100 985,100 995,110 1005,100 1015,100 1025,40 1035,100 1045,100 1055,120 1065,100 1075,100 1085,60 1095,100 1105,100 1115,100 1125,85 1135,100 1145,100 1155,50 1165,100 1175,100 1200,100"
        />
      </svg>
    </div>
    <div className="absolute inset-0 flex items-center" style={{ animation: 'wavePulse 5s ease-in-out infinite 1s' }}>
      <svg viewBox="0 0 2400 200" className="w-[200%] h-32 opacity-[0.05]" style={{ animation: 'waveMove2 12s linear infinite' }} preserveAspectRatio="none">
        <polyline
          fill="none"
          stroke="#22c55e"
          strokeWidth="1.5"
